...
function Trains() {
  ...
  return (
    <div className=" bg-cover bg-center h-[30rem] flex items-center justify-center text-white text-2xl w-full ">
              <div className="absolute inset-0 z-[-1] bg-cover bg-center opacity-50 travel h-[50rem]" ></div>
        ...
        <div className="flex-1">
          <div className="mb-4">
            ...
            >
              ...
              <option value="double">Sleeper Class</option>
              <option value="suite">Third AC</option>
              <option value="suite">Second AC</option>
              <option value="suite">First AC</option>
              <option value="suite">Second Sitting</option>
              <option value="suite">AC Chair Car</option>
              <option value="suite">Vistadome</option>
